...
int main() {
    ...
    cout << "Dataset Info: nb=" << nb << ", d=" << d << endl; // 确保这里输出 1000000
    ...
    string IVF_FILE = "indices/" + clean_base_name + "_IVF_final.index";
    string HNSW_FILE = "indices/" + clean_base_name + "_HNSW_final.index";
